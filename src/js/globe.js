...
const countriesLowFC = topojson.feature(
  countriesLow,
  countriesLow.objects.ne_10m_admin_0_countries
);
...
const stored = pointsWithFeature.map((o) => {
  return {
    ...
    features: topojson
      .feature(countriesLow, countriesLow.objects.ne_10m_admin_0_countries)
      .features.filter((c) =>
        o.cases.some((coun) => c.properties.ISO_A3 === coun.iso)
      ),
  };
});
...
let colorLand = "#d9d9d9";
let colorLandSelected = "#ffeaee";
let graticuleColor = "#121212";
let lineLand = "#cccccc";
